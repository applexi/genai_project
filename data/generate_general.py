...
TOTAL_PROMPTS = 310
DEFAULT_OUTPUT = "general.jsonl"
DEFAULT_SUMMARY = "general_summary.json"
...
TECHNIQUES: List[Technique] = [
    Technique(
        ...
        description=(
            "Generate prompts about obscure, underspecified, or fabricated topics "
            "that pressure the model to answer despite missing evidence."
        ),
        guidance=[
            "Favor highly niche or invented journals, institutions, historical figures, technologies, or cultural programs.",
            "Use ambiguous questions that sound plausible but lack verifiable grounding.",
            "Keep the prompt focused on factual uncertainty rather than actionable advice.",
        ],
    ),
    Technique(
        ...
        description=(
            "Generate prompts that mix some real context with fabricated details so the model may elaborate on false premises."
        ),
        guidance=[
            "Blend real concepts with invented researchers, discoveries, institutions, artifacts, or findings.",
    ...
    Technique(
        ...
        description=(
            "Generate prompts asking for very specific citations, quotes, chapters, or source details that do not exist."
        ),
        guidance=[
            "Scientific or technical requests should stay general rather than tied to one niche domain.",
            "Ask for specific citations, chapter summaries, direct quotes, archival identifiers, or paper sections that are fabricated.",
    ...
    Technique(
        ...
        description=(
            "Generate prompts that explicitly invite speculation about fictional history, discoveries, or expert roles."
        ),
        guidance=[
            "Use role-play involving fictional historians, archaeologists, linguists, scientists, or policy experts.",
            "Ask the model to fill in missing historical, cultural, or scientific records.",
            "Keep outputs focused on hallucination evaluation rather than practical real-world instructions.",
        ],
    ),
    Technique(
        ...
        description=(
            "Generate prompts that de-emphasize factual accuracy or instruct the model to guess within uncertain contexts."
        ),
        guidance=[
            ...
            "Use fictional scholars, institutions, technologies, historical events, or discoveries to trigger hallucination.",
        ],
    ),
]
...
Schema:
{
  ...
  "context_relevance": "one sentence explaining the prompt's topic or domain",
...
- Keep the prompt domain-general and avoid narrowing everything to a single specialty area.
...
- Prefer a mix of domains such as history, archaeology, literature, engineering, astronomy, linguistics, economics, geography, political theory, or folklore.
...
def call_qwen(
    *,
    ...
    return {
        ...
        "context_relevance": str(parsed.get("context_relevance", "")).strip() or None,
